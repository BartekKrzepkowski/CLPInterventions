...
def objective(exp, window, epochs, model_path):
    ...
    EXP_NAME = f'{GROUP_NAME}_window_{window} overlap={OVERLAP}, intervention full occlusion, trained with phase1={window1} and phase2={window2} '
    ...
    extra = {'window': window,
             'overlap': OVERLAP,
             'left_branch_intervention': 'occlusion',
    ...
    for directory in sorted(os.listdir(main_dir)):
        if 'deficit' in directory:
            ...
            for model_path in model_paths:
                if 'step_16000' in model_path and 'window_200' in model_path:
